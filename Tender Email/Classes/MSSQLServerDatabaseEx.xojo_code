...
Inherits MSSQLServerDatabase
	...
	#tag Method, Flags = &h1
		Protected Sub Connect()
		  ...
		  Me.Host = app.ConfigurationItems.Item.Value("DatabaseServerName")
		  Me.DatabaseName = app.ConfigurationItems.Item.Value("DatabaseName")
		  Me.Username = app.ConfigurationItems.Item.Value("DatabaseUserName")
		  Me.password = app.ConfigurationItems.Item.Value("DatabasePassword")
