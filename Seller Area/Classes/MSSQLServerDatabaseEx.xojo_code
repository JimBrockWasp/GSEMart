#tag Class
Protected Class MSSQLServerDatabaseEx
Inherits MSSQLServerDatabase
	#tag Method, Flags = &h0
	...
	#tag Method, Flags = &h1
		Protected Sub Connect()
		  ...
		  Me.Host = Session.ConfigurationItems.Item.Value("DatabaseServerName")
		  Me.DatabaseName = Session.ConfigurationItems.Item.Value("DatabaseName")
		  Me.Username = Session.ConfigurationItems.Item.Value("DatabaseUserName")
		  Me.Password = Session.ConfigurationItems.Item.Value("DatabasePassword")
