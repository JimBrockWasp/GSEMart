...
public class NVPAPICaller
{
    ...
    private bool bSandbox = Convert.ToBoolean(ConfigurationManager.AppSettings["Sandbox"]);
    ...
    /// <param ref name="retMsg"></param>
    /// <returns></returns>
    public bool ConfirmPayment(string finalPaymentAmount, string CurrencyId,  string token, string PayerId, ref NVPCodec decoder, ref string retMsg )
    {
		if (bSandbox)
		{
			pendpointurl = "https://api-3t.sandbox.paypal.com/nvp";
        ...
        encoder["CURRENCYCODE"] = CurrencyId;
